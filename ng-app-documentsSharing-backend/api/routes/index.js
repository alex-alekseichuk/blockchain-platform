...
const postCreateDocument = (req, res) => {
  services.documents.createDocumentService(req.body, req.user.id)
...
const postActionsGetFederationNodes = (req, res) => {
  ...
  services.documents.getFederationNodes(contractId, function(data) {
    res.send(data);
  });
};
...
const postActionsGetSecretPart = (req, res) => {
  ...
  services.documents.getSecretKeyPart(contractId, pubKey, federationNodeAddress, function(data) {
    res.send(data);
  });
};
...
const postActionsSaveSecretPart = (req, res) => {
  ...
  services.documents.saveSecretKeyPart(contractId, pubKey, federationNodeAddress, keyPart, timeout, function(data) {
    res.send(data);
  });
};
